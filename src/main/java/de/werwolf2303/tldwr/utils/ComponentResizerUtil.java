 ...
 * the component.
 */
public class ComponentResizerUtil extends MouseAdapter {
     ...
     */
    public ComponentResizerUtil(Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public ComponentResizerUtil(Insets dragInsets, Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public ComponentResizerUtil(Insets dragInsets, Dimension snapSize, Component... components) {
    ...
    protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current) {
        ...
        Rectangle currentScreenBounds = getActiveScreen(source).getDefaultConfiguration().getBounds();
    ...
    public static void logScreens() {
        ...
        for (GraphicsDevice gd : GraphicsEnvironment.getLocalGraphicsEnvironment().getScreenDevices()) {
            ...
            if (gd.getType() == 0) {//screen
                sb.append(gd.getDisplayMode());
            }
        }
        System.err.println("screens: " + sb);
    }

    private static boolean idNotShown = true;
    private GraphicsDevice getActiveScreen(Component frame) {
        ...
        if (idNotShown) {
            System.err.println("Screen - " + myDevice.getIDstring());
            idNotShown = false;
        }
        return myDevice;
    }
 ...
 *  Keep the size of the component within the bounds of its parent.
    ...
    private Dimension getBoundingSize(Component source) {
        if (source instanceof Window) {
            ...
            Rectangle boundz = new Rectangle();
            ...
            return new Dimension(boundz.width, boundz.height);
        } else {
